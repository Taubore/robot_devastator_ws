...
3. vérifier la mesure à gauche, puis la mesure à droite ;
4. vérifier la rotation courte vers le côté le plus dégagé ;
5. vérifier le recentrage de la tourelle ;
6. vérifier que l'avance reprend seulement lorsque la mesure avant est valide et dégagée.

Les angles de tourelle, le délai de stabilisation, la vitesse et la durée de rotation restent
empiriques. Ils devront être ajustés progressivement sur le Raspberry Pi 4 avec le robot sécurisé.
