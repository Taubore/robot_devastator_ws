...
| INA260 | Adafruit INA260 (x2) | Mesure alimentation | Mesure tension/courant | Actif | Deux capteurs I2C insérés en série sur le positif de chaque batterie : 0x40 sur le rail logique, 0x41 sur le rail moteur. Intégrés et validés sur le robot réel ; lus en permanence par le nœud `surveillance_alimentation`, lancé par `devastator.launch.yaml`. |
