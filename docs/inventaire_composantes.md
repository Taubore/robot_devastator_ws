...
| AUDIO_I2S | MAX98357 + PCM5102A | Audio | Amplification et conversion audio | Gelé | Modules audio prévus pour générer et amplifier et donner une voix au robot avec Piper. |
| HP_BF37 | Visaton BF 37 | Audio | Sortie sonore du robot | Gelé | Haut-parleur 8 Ω prévu pour la voix du robot et les retours sonores via la chaîne audio I2S. |
